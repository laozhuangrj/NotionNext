...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '老庄日记', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '每日三省：读书了吗？运动了吗？赚钱了吗？🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lzrj.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '知识库, 博客，个人成长', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'lz@lzrj.fun ', // 邮箱地址 例如mail@tangly1024.com
...
<meta name="baidu-site-verification" content="codeva-d7jb8YQ7fh" />
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-XG1TZ9RGC2', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-7743207318653736', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '9943858148', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ...
  ADSENSE_GOOGLE_SLOT_AUTO: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '5621469757', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
